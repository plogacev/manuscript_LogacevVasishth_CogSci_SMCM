...
Next, we look at the superficial data (subsetted). This is an incorrect analysis because it hides the by items (in by-subject anova) or by subjects (in by-items anova) variability.
